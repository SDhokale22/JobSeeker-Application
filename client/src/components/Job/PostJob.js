...
const PostJob = () => {
  ...
  const handleJobPost = async(e) => {
    ...
    await axios.post("http://localhost:8000/api/v1/job/post", 
    fixedSalary.length >=4 
    ? {title, category, country, description, city, location, fixedSalary}
    : {title, category, country, description, city, location, salaryFrom, salaryTo},
     {
