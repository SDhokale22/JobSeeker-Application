...
const MyJobs = () => {
  ...
  useEffect(() => {
    const fetchJobs = async() => {
      try {
        const {data} = await axios.get("http://localhost:8000/api/v1/job/myJobs",
  ...
  //fetching enable editing mode
  const handleEnableEdit = (jobId) => {
    setEditingMode(jobId);
  };

  //fetching disable editing mode
  const handleDisableEdit = () => {
    setEditingMode(null);
  };

  //fetching editing mode
                        ...
                        <div className='content'>
                          <div className='short_fields'>
                            <div>
                              <span>Title: </span>
                              <input type='text' 
                              disabled={editingMode !== element._id  ? true : false} value={element.title} 
                            ...
                            <div>
                              <span>Country: </span>
                              <input type='text' 
                              disabled={editingMode !== element._id  ? true : false} value={element.country} 
                            ...
                            <div>
                              <span>City: </span>
                              <input type='text' 
                              disabled={editingMode !== element._id  ? true : false} value={element.city} 
